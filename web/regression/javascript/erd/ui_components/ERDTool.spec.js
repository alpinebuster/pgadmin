...
describe('ERDTool', ()=>{
  ...
  it('onSQLClick', (done)=>{
    ...
    setTimeout(()=>{
      let sql = '-- This script was generated by the ERD tool in pgAdmin.\n'
      + '-- Please log an issue at https://redmine.postgresql.org/projects/pgadmin/issues/new if you find any bugs, including reproduction steps.\n'
      + 'BEGIN;\nSELECT 1;\nEND;';
