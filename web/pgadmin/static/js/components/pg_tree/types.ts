import {
  IFileTreeHandle, FileEntry, Directory,
  FileType, IFileEntryItem, IItemRenderer,
  FileOrDir
} from 'react-aspen';
...
// Here imagination is your limit! IFileTreeHandle has core low-level features
// you can build on top of as your application needs
...
export interface IFileTreeXProps {
  ...
  ) => IFileEntryItem | Promise<IFileEntryItem>
