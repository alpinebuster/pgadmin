...
class UserMappingDependentsAndDependencyTestCase(BaseTestGenerator):
    ...
    def dependents_user_mapping(self):
        """
        This function returns the user mapping dependents response
        :return: user mapping dependents response
        """
    ...
    def runTest(self):
        ...
        if self.is_positive_test:
            response = self.dependents_user_mapping()
