...
class ERDTool extends React.Component {
  ...
  onSQLClick(sqlWithDrop=false) {
    let scriptHeader = gettext('-- This script was generated by the ERD tool in pgAdmin.\n');
    scriptHeader += gettext('-- Please log an issue at https://redmine.postgresql.org/projects/pgadmin/issues/new if you find any bugs, including reproduction steps.\n');
